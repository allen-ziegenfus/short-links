...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.osb.www.shortlink.service.http.ShortLinkEntryServiceSoap}.
 *
...
public class ShortLinkEntrySoap implements Serializable {
	...
	public static ShortLinkEntrySoap toSoapModel(ShortLinkEntry model) {
		...
		soapModel.setHttpStatusCode(model.getHttpStatusCode());
	...
	public static ShortLinkEntrySoap[][] toSoapModels(
		ShortLinkEntry[][] models) {

		ShortLinkEntrySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new ShortLinkEntrySoap[models.length][models[0].length];
		}
		else {
	...
	public static ShortLinkEntrySoap[] toSoapModels(
		List<ShortLinkEntry> models) {

		List<ShortLinkEntrySoap> soapModels = new ArrayList<ShortLinkEntrySoap>(
			models.size());
