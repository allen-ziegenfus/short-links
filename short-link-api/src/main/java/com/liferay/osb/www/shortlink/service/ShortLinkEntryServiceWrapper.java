 ...
 * @generated
 */
public class ShortLinkEntryServiceWrapper
	implements ServiceWrapper<ShortLinkEntryService>, ShortLinkEntryService {
	...
	public String getOSGiServiceIdentifier() {
		return _shortLinkEntryService.getOSGiServiceIdentifier();
	}
